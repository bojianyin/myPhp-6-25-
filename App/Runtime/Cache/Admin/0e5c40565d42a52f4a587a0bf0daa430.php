...
<head>
	...
	<style>
		...
		form{width:250px;padding:20px;margin:50px auto;border:1px solid #e0e0e0;background: #fff;border-radius:10px;}
	</style>
</head>
<body>
	<form class="form-horizonta" action="<?php echo U('Admin/Login/Login');?>" method="post">
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-5">
	    	<img src="<?php echo U('Admin/Login/verify','','');?>" alt="code" class="col-sm-5">
			<a href="javascript:;" class="btn-link col-sm-5 toggle_code">看不清,换一张</a>
	    </div>
	  </div>
	  <div class="form-group">
