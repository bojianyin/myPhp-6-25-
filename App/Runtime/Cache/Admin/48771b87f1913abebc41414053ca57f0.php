			...
			<div class="table-responsive">
			  <table class="table">
				...
				<nav aria-label="...">
				  <ul class="pagination">
				  	<li>
				      <a href="<?php echo U(Admin/Index/index,'bn=prev';?>" aria-label="Previous">
				        <span aria-hidden="true">&laquo;</span>
				      </a>
				    </li>

				  	<?php $__FOR_START_6551__=0;$__FOR_END_6551__=$num;for($k=$__FOR_START_6551__;$k < $__FOR_END_6551__;$k+=1){ ?><li><a href="<?php echo U(Admin/Index/index,'p='.($k+1));?>"><?php echo ($k+1); ?><span class="sr-only">(current)</span></a></li><?php } ?>
				    <li>
				      <a href="<?php echo U(Admin/Index/index,'bn=next';?>" aria-label="Next">
