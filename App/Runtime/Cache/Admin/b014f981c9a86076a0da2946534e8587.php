			  ...
			  <table class="table">
				...
				<nav aria-label="...">
				  <ul class="pagination">
				  	...
				  	<?php $__FOR_START_338__=0;$__FOR_END_338__=$num;for($k=$__FOR_START_338__;$k < $__FOR_END_338__;$k+=1){ ?><li><a href="<?php echo U(Admin/Index/index,'p='.($k+1));?>"><?php echo ($k+1); ?><span class="sr-only">(current)</span></a></li><?php } ?>
				    <li>
